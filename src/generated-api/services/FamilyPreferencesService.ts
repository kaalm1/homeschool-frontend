...
export class FamilyPreferencesService {
   ...
   * @throws ApiError
   */
  public static resetFamilyPreferencesApiV1FamilyPreferencesApiV1FamilyPreferencesDelete(): CancelablePromise<
   ...
   * @throws ApiError
   */
  public static resetFamilyPreferencesApiV1FamilyPreferencesApiV1FamilyPreferencesDelete1(): CancelablePromise<
    Record<string, string>
  > {
    return __request(OpenAPI, {
      method: 'DELETE',
