...
export class WeekActivitiesService {
     ...
     * @throws ApiError
     */
    public static getCurrentWeekActivitiesApiV1WeekActivitiesWeekActivitiesCurrentGet(): CancelablePromise<Array<WeekActivityResponse>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getAvailableWeeksApiV1WeekActivitiesWeekActivitiesWeeksGet(): CancelablePromise<Array<Record<string, any>>> {
        return __request(OpenAPI, {
            method: 'GET',
